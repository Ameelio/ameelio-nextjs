// Media
import Bloomberg from "assets/Media/Bloomberg.png";
import Forbes from "assets/Media/Forbes.png";
import TechCrunch from "assets/Media/TechCrunch.png";
import BusinessInsider from "assets/Media/BusinessInsider.png";
import Wapo from "assets/Media/Wapo.png";
import FastCompany from "assets/Media/FastCompany.png";
import { ShowcaseItem } from "types";

export const MEDIA: ShowcaseItem[] = [
  {
    asset: Bloomberg,
