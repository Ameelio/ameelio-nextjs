    ...
    <div className="bg-blue-700">
      <PaddedLayout className="bg-blue-700 py-16">
        <div className="flex flex-col-reverse md:flex-row gap-y-8">
          <div className="flex items-center space-y-2 md:space-x-4 flex-col md:flex-row flex-1">
            ...
            <div className="flex flex-col">
              <span className="text-white font-bold text-center md:text-left">
                {author}
              </span>
              <span className="text-white opacity-50 text-center md:text-left">
                {occupation}
              </span>
            </div>
          </div>
          <div className="flex flex-col md:flex-row md:gap-x-2 flex-1">
            <span className="text-white text-7xl text-center md:text-left">
              “
            </span>
